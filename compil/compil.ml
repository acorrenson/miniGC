type int_expr =
  ...
  | Prod of int_expr * int_expr
  | VDot of vect_expr * vect_expr
  (* | VMag of vect_expr
     | VDot of vect_expr * vect_expr *)

and vect_expr =
  | Vec of int_expr * int_expr
  | VSum of vect_expr * vect_expr
  (* | VProd of vect_expr * vect_expr *)
(* | VScale of int_expr * vect_expr *)
